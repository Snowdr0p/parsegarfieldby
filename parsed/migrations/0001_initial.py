    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(verbose_name='URL-адрес')),
                ('animal', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='parsed.animal')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='BYN', max_digits=9, verbose_name='цена')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='parsed.category')),
            ],
            options={
                'verbose_name': 'товар',
        ...
        migrations.AddField(
            model_name='animal',
            name='site',
            field=models.ManyToManyField(to='parsed.site'),
        ),
    ]
